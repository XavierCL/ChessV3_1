...
public class GameStateChecker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var factory1 = new V12GameStateFactory();
        var factory2 = new V11GameStateFactory();
        ...
        Debug.Log(V12LegalMoveGenerator.legalCache.ToString());
        Debug.Log(V11LegalMoveGenerator.legalCache.ToString());
    ...
    private List<GameStateInterface> StartingPositions()
    {
        return new List<GameStateInterface> {
            ...
            new V1GameStateFactory().FromFen("4b2k/3p1p1p/3P1P1P/8/8/p1p1p3/P1P1P3/K2B4 w -"),
