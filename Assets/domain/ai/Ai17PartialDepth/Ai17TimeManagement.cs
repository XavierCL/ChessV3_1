...
public class Ai17TimeManagement
{
  ...
  public Ai17TimeManagement(TimeSpan remainingTime, TimeSpan increment, CancellationToken cancellationToken, int forcedDepth)
  {
