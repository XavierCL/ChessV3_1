public static class Ai17SearchExtension
{
  public static Ai17SearchResult Search(V17GameState gameState, Ai17SearchResult alpha, Ai17SearchResult beta, Ai17SearchResult.HyperParameters hyperParameters)
  {
    var lastMove = gameState.History[^1];
    if (lastMove.killed == null || !hyperParameters.searchExtensions) return Ai17Evaluate.Evaluate(gameState, hyperParameters);
    ...
    var idleEvaluation = Ai17Evaluate.Evaluate(gameState, hyperParameters);
