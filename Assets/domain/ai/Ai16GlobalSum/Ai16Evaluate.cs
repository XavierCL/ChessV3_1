...
public static class Ai16Evaluate
{
  public static Ai16SearchResult Evaluate(V17GameState gameState, Ai16SearchResult.HyperParameters hyperParameters)
  {
    ...
    var value = whiteScore - blackScore + middleKingEndGame;

    return new Ai16SearchResult(
      value,
      value,
      false,
      1,
  ...
  public static readonly double MAX_EVALUATION = 9 * 9 + 2 * 5 + 4 * 3 + 1;
}