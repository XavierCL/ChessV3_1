...
public class Ai14TimeManagement
{
  ...
  public Ai14TimeManagement(TimeSpan remainingTime, TimeSpan increment, CancellationToken cancellationToken, int forcedDepth)
  {
