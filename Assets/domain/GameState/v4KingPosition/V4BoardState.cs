...
public class V4BoardState : BoardStateInterface
{
  ...
  public V4BoardState(bool whiteTurn, List<PiecePosition> piecePositions, PieceType[] boardPieces, CastleFlags castleFlags, int enPassantColumn, BoardPosition whiteKingPosition, BoardPosition blackKingPosition)
  {
  ...
  public V4BoardState(bool whiteTurn, List<PiecePosition> piecePositions, CastleFlags castleFlags)
  {
    this.whiteTurn = whiteTurn;
    this.piecePositions = piecePositions;
    this.castleFlags = castleFlags;
