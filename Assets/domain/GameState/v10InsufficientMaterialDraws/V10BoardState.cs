...
public class V10BoardState : BoardStateInterface
{
  ...
  public V10BoardState(bool whiteTurn, PieceType[] boardPieces, ulong allBitBoard, bool whiteCastleKingSide, bool whiteCastleQueenSide, bool blackCastleKingSide, bool blackCastleQueenSide, int enPassantColumn, int whiteKingPosition, int blackKingPosition)
  {
  ...
  public V10BoardState(bool whiteTurn, List<PiecePosition> piecePositions, bool whiteCastleKingSide, bool whiteCastleQueenSide, bool blackCastleKingSide, bool blackCastleQueenSide)
  {
    this.whiteTurn = whiteTurn;
    this.whiteCastleKingSide = whiteCastleKingSide;
    this.whiteCastleQueenSide = whiteCastleQueenSide;
  ...
  {
    public readonly V10BoardState boardState;
    public readonly PiecePosition sourcePiece;
    public readonly PiecePosition killedPiece;

    public BoardStatePlay(V10BoardState boardState, PiecePosition sourcePiece, PiecePosition killedPiece)
    {
  ...
  public V10BoardState UndoMove(ReversibleMove reversibleMove)
  {
