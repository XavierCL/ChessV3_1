...
public class V11GameState : GameStateInterface
{
    ...
    public V11BoardState boardState;
    ...
    public Dictionary<V11BoardState, ushort> snapshots { get; }
    ...
    public V11GameState()
    {
        ...
        boardState = new V11BoardState();
        snapshots = new Dictionary<V11BoardState, ushort>();
    }

    public V11GameState(GameStateInterface gameState)
    {
        staleTurns = gameState.StaleTurns;
        history = new List<ReversibleMove>(gameState.history);
        boardState = new V11BoardState(gameState.BoardState);
        snapshots = gameState.Snapshots.ToDictionary(tuple => new V11BoardState(tuple.Key), tuple => tuple.Value);
    }

    public V11GameState(List<PiecePosition> piecePositions, bool whiteStarts, CastleFlags castling)
    {
        staleTurns = 0;
        history = new List<ReversibleMove>();
        boardState = new V11BoardState(
    ...
    public override GameEndState GetGameEndState()
    {
        ...
        var canOwnKingDie = V11LegalMoveGenerator.CanOwnKingDie(this);
