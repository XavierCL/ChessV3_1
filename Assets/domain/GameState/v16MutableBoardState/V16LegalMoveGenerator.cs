...
public static class V16LegalMoveGenerator
{
  ...
  private static bool DrawByInsufficientMaterial(AugmentedBoardState boardState)
  {
    ...
    var onGoingBitBoards = boardState.boardState.bitBoards[V16BoardState.WhitePawn]
      | boardState.boardState.bitBoards[V16BoardState.BlackPawn]
      | boardState.boardState.bitBoards[V16BoardState.WhiteRook]
      | boardState.boardState.bitBoards[V16BoardState.BlackRook]
      | boardState.boardState.bitBoards[V16BoardState.WhiteQueen]
      | boardState.boardState.bitBoards[V16BoardState.BlackQueen];
    ...
    if (boardState.boardState.bitBoards[V16BoardState.WhiteBishop] != 0
      && boardState.boardState.bitBoards[V16BoardState.BlackBishop] != 0
      && boardState.boardState.bitBoards[V16BoardState.WhiteBishop].lsbUnchecked().IsWhiteSquare() == boardState.boardState.bitBoards[V16BoardState.BlackBishop].lsbUnchecked().IsWhiteSquare())
    {
      return true;
    }
  ...
  public static IReadOnlyList<Move> GenerateLegalMoves(this V16GameState gameState)
  {
    InitializeCache();
  ...
  public static bool GenerateHasLegalMoves(this V16GameState gameState)
  {
    InitializeCache();
  ...
  private static CacheEntry GenerateBoardLegalMoves(V16BoardState rawBoardState, CacheEntryType entryType)
  {
    ...
    var kingPosition = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V16BoardState.WhiteKing : V16BoardState.BlackKing].lsbUnchecked();
    ...
    if (entryType == CacheEntryType.HasMove)
    {
      ...
      var pawnPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V16BoardState.WhitePawn : V16BoardState.BlackPawn].extractIndices();
      ...
      var bishopPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V16BoardState.WhiteBishop : V16BoardState.BlackBishop].extractIndices();
      ...
      var knightPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V16BoardState.WhiteKnight : V16BoardState.BlackKnight].extractIndices();
      ...
      var rookPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V16BoardState.WhiteRook : V16BoardState.BlackRook].extractIndices();
      ...
      var queenPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V16BoardState.WhiteQueen : V16BoardState.BlackQueen].extractIndices();
  ...
  {
    var kingPosition = (whiteKing ? boardState.boardState.bitBoards[V16BoardState.WhiteKing] : boardState.boardState.bitBoards[V16BoardState.BlackKing]).lsbUnchecked();

    // Enemy king
    if ((V16Precomputed.kingBitBoards[kingPosition] & (whiteKing ? boardState.boardState.bitBoards[V16BoardState.BlackKing] : boardState.boardState.bitBoards[V16BoardState.WhiteKing])) != 0) return true;

    // Enemy knights
    if ((V16Precomputed.knightBitBoards[kingPosition] & (whiteKing ? boardState.boardState.bitBoards[V16BoardState.BlackKnight] : boardState.boardState.bitBoards[V16BoardState.WhiteKnight])) != 0) return true;

    // Enemy pawns
    if ((whiteKing ? V16Precomputed.whitePawnCaptureBitBoards[kingPosition] & boardState.boardState.bitBoards[V16BoardState.BlackPawn] : V16Precomputed.blackPawnCaptureBitBoards[kingPosition] & boardState.boardState.bitBoards[V16BoardState.WhitePawn]) != 0) return true;
  ...
  private static KingCheckInfo GetKingCheckInfo(AugmentedBoardState boardState, bool whiteKing)
  {
    ...
    // Enemy king
    var kingAttackers = V16Precomputed.kingBitBoards[kingPosition] & (whiteKing ? boardState.boardState.bitBoards[V16BoardState.BlackKing] : boardState.boardState.bitBoards[V16BoardState.WhiteKing]);
    attackers |= kingAttackers;
    middleRay |= kingAttackers;

    // Enemy knights
    var knightAttackers = V16Precomputed.knightBitBoards[kingPosition] & (whiteKing ? boardState.boardState.bitBoards[V16BoardState.BlackKnight] : boardState.boardState.bitBoards[V16BoardState.WhiteKnight]);
    attackers |= knightAttackers;
    middleRay |= knightAttackers;

    // Enemy pawns
    var pawnAttackers = whiteKing ? V16Precomputed.whitePawnCaptureBitBoards[kingPosition] & boardState.boardState.bitBoards[V16BoardState.BlackPawn] : V16Precomputed.blackPawnCaptureBitBoards[kingPosition] & boardState.boardState.bitBoards[V16BoardState.WhitePawn];
  ...
  private static Move[] GetConstrainedLegalPawnMoves(CheckInfoBoardState boardState, int position, CacheEntryType entryType)
  {
    ...
    {
      targetBitBoard &= V16Precomputed.pinRays[position][boardState.preservingKingPosition];
    }
  ...
  {
    var targetBitBoard = V16Precomputed.knightBitBoards[position] & ~(boardState.boardState.whiteTurn ? boardState.whiteBitBoard : boardState.blackBitBoard);
  ...
  {
    var values = V16Precomputed.bitBoardAtRayBranches[(colIncrement + 1) * 3 + rowIncrement + 1][position] & allPieces;
  ...
  {
    var rayBitBoard = V16Precomputed.bitBoardAtRayBranches[(colIncrement + 1) * 3 + rowIncrement + 1][position];
  ...
  private static Move[] TargetBitBoardToMoves(int sourcePosition, ulong targetBitBoard)
  {
    ...
    for (var index = 0; index < bitCount; ++index)
    {
      ...
      moves[index] = V16Precomputed.moves[sourcePosition][nextTarget];
    }
  ...
  private class AugmentedBoardState
  {
    ...
    public AugmentedBoardState(V16BoardState boardState)
    {
      this.boardState = boardState;

      whiteBitBoard = boardState.bitBoards[V16BoardState.WhitePawn]
        | boardState.bitBoards[V16BoardState.WhiteRook]
        | boardState.bitBoards[V16BoardState.WhiteKnight]
        | boardState.bitBoards[V16BoardState.WhiteBishop]
        | boardState.bitBoards[V16BoardState.WhiteQueen]
        | boardState.bitBoards[V16BoardState.WhiteKing];

      blackBitBoard = boardState.bitBoards[V16BoardState.BlackPawn]
        | boardState.bitBoards[V16BoardState.BlackRook]
        | boardState.bitBoards[V16BoardState.BlackKnight]
  ...
  private class CheckInfoBoardState
  {
    ...
    public CheckInfoBoardState(AugmentedBoardState boardState)
    {
      ...
      this.preservingKingPosition = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V16BoardState.WhiteKing : V16BoardState.BlackKing].lsbUnchecked();
    }
  }
