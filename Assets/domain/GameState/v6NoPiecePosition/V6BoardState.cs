...
public class V6BoardState : BoardStateInterface
{
  ...
  public V6BoardState(PieceType[] boardPieces, bool whiteCastleKingSide, bool whiteCastleQueenSide, bool blackCastleKingSide, bool blackCastleQueenSide, int enPassantColumn, BoardPosition whiteKingPosition, BoardPosition blackKingPosition)
  {
  ...
  public V6BoardState(List<PiecePosition> piecePositions, bool whiteCastleKingSide, bool whiteCastleQueenSide, bool blackCastleKingSide, bool blackCastleQueenSide)
  {
    this.whiteCastleKingSide = whiteCastleKingSide;
    this.whiteCastleQueenSide = whiteCastleQueenSide;
    this.blackCastleKingSide = blackCastleKingSide;
  ...
  {
    public V6BoardState boardState { get; set; }
  ...
  public V6BoardState UndoMove(ReversibleMove reversibleMove)
  {
    var newBoardPieces = (PieceType[])boardPieces.Clone();
  ...
  public override bool Equals(object obj)
  {
    ...
    return boardPieces.SequenceEqual(other.boardPieces);
  }
