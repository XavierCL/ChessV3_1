...
public static class V15LegalMoveGenerator
{
  ...
  private static bool DrawByInsufficientMaterial(AugmentedBoardState boardState)
  {
    ...
    var onGoingBitBoards = boardState.boardState.bitBoards[V15BoardState.WhitePawn]
      | boardState.boardState.bitBoards[V15BoardState.BlackPawn]
      | boardState.boardState.bitBoards[V15BoardState.WhiteRook]
      | boardState.boardState.bitBoards[V15BoardState.BlackRook]
      | boardState.boardState.bitBoards[V15BoardState.WhiteQueen]
      | boardState.boardState.bitBoards[V15BoardState.BlackQueen];
    ...
    if (boardState.boardState.bitBoards[V15BoardState.WhiteBishop] != 0
      && boardState.boardState.bitBoards[V15BoardState.BlackBishop] != 0
      && boardState.boardState.bitBoards[V15BoardState.WhiteBishop].lsbUnchecked().IsWhiteSquare() == boardState.boardState.bitBoards[V15BoardState.BlackBishop].lsbUnchecked().IsWhiteSquare())
    {
      return true;
    }
  ...
  public static IReadOnlyList<Move> GenerateLegalMoves(this V15GameState gameState)
  {
    InitializeCache();
  ...
  public static bool GenerateHasLegalMoves(this V15GameState gameState)
  {
    InitializeCache();
  ...
  private static CacheEntry GenerateBoardLegalMoves(V15BoardState rawBoardState, CacheEntryType entryType)
  {
    ...
    var kingPosition = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V15BoardState.WhiteKing : V15BoardState.BlackKing].lsbUnchecked();
    ...
    if (entryType == CacheEntryType.HasMove)
    {
      ...
      var pawnPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V15BoardState.WhitePawn : V15BoardState.BlackPawn].extractIndices();
      ...
      var bishopPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V15BoardState.WhiteBishop : V15BoardState.BlackBishop].extractIndices();
      ...
      var knightPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V15BoardState.WhiteKnight : V15BoardState.BlackKnight].extractIndices();
      ...
      var rookPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V15BoardState.WhiteRook : V15BoardState.BlackRook].extractIndices();
      ...
      var queenPositions = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V15BoardState.WhiteQueen : V15BoardState.BlackQueen].extractIndices();
  ...
  public static bool CanOwnKingDie(V15GameState gameState)
  {
  ...
  {
    var kingPosition = (whiteKing ? boardState.boardState.bitBoards[V15BoardState.WhiteKing] : boardState.boardState.bitBoards[V15BoardState.BlackKing]).lsbUnchecked();

    // Enemy king
    if ((V15Precomputed.kingBitBoards[kingPosition] & (whiteKing ? boardState.boardState.bitBoards[V15BoardState.BlackKing] : boardState.boardState.bitBoards[V15BoardState.WhiteKing])) != 0) return true;

    // Enemy knights
    if ((V15Precomputed.knightBitBoards[kingPosition] & (whiteKing ? boardState.boardState.bitBoards[V15BoardState.BlackKnight] : boardState.boardState.bitBoards[V15BoardState.WhiteKnight])) != 0) return true;

    // Enemy pawns
    if ((whiteKing ? V15Precomputed.whitePawnCaptureBitBoards[kingPosition] & boardState.boardState.bitBoards[V15BoardState.BlackPawn] : V15Precomputed.blackPawnCaptureBitBoards[kingPosition] & boardState.boardState.bitBoards[V15BoardState.WhitePawn]) != 0) return true;
    ...
    var linearEnemyBitBoard = whiteKing
      ? boardState.boardState.bitBoards[V15BoardState.BlackQueen] | boardState.boardState.bitBoards[V15BoardState.BlackRook]
      : boardState.boardState.bitBoards[V15BoardState.WhiteQueen] | boardState.boardState.bitBoards[V15BoardState.WhiteRook];
    ...
    var diagonalEnemyBitBoard = whiteKing
      ? boardState.boardState.bitBoards[V15BoardState.BlackQueen] | boardState.boardState.bitBoards[V15BoardState.BlackBishop]
      : boardState.boardState.bitBoards[V15BoardState.WhiteQueen] | boardState.boardState.bitBoards[V15BoardState.WhiteBishop];
  ...
  private static KingCheckInfo GetKingCheckInfo(AugmentedBoardState boardState, bool whiteKing)
  {
    ...
    // Enemy king
    var kingAttackers = V15Precomputed.kingBitBoards[kingPosition] & (whiteKing ? boardState.boardState.bitBoards[V15BoardState.BlackKing] : boardState.boardState.bitBoards[V15BoardState.WhiteKing]);
    attackers |= kingAttackers;
    middleRay |= kingAttackers;

    // Enemy knights
    var knightAttackers = V15Precomputed.knightBitBoards[kingPosition] & (whiteKing ? boardState.boardState.bitBoards[V15BoardState.BlackKnight] : boardState.boardState.bitBoards[V15BoardState.WhiteKnight]);
    attackers |= knightAttackers;
    middleRay |= knightAttackers;

    // Enemy pawns
    var pawnAttackers = whiteKing ? V15Precomputed.whitePawnCaptureBitBoards[kingPosition] & boardState.boardState.bitBoards[V15BoardState.BlackPawn] : V15Precomputed.blackPawnCaptureBitBoards[kingPosition] & boardState.boardState.bitBoards[V15BoardState.WhitePawn];
  ...
  private static Move[] GetConstrainedLegalPawnMoves(CheckInfoBoardState boardState, int position, CacheEntryType entryType)
  {
    ...
    {
      targetBitBoard &= V15Precomputed.pinRays[position][boardState.preservingKingPosition];
    }
  ...
  {
    var targetBitBoard = V15Precomputed.knightBitBoards[position] & ~(boardState.boardState.whiteTurn ? boardState.whiteBitBoard : boardState.blackBitBoard);
  ...
  {
    var normalMoveTargetBitBoard = V15Precomputed.kingBitBoards[position] & ~(boardState.boardState.whiteTurn ? boardState.whiteBitBoard : boardState.blackBitBoard);
    ...
    var boardStateCopy = new V15BoardState(boardState.boardState);
    var ownBitBoard = position.toBitBoard();
    var ownKingBitBoardIndex = boardState.boardState.whiteTurn ? V15BoardState.WhiteKing : V15BoardState.BlackKing;
    var targetBitBoard = 0ul;
  ...
  {
    var values = V15Precomputed.bitBoardAtRayBranches[(colIncrement + 1) * 3 + rowIncrement + 1][position] & allPieces;
  ...
  {
    var rayBitBoard = V15Precomputed.bitBoardAtRayBranches[(colIncrement + 1) * 3 + rowIncrement + 1][position];
  ...
  private static Move[] TargetBitBoardToMoves(int sourcePosition, ulong targetBitBoard)
  {
    ...
    for (var index = 0; index < bitCount; ++index)
    {
      ...
      moves[index] = V15Precomputed.moves[sourcePosition][nextTarget];
    }
  ...
  private class AugmentedBoardState
  {
    ...
    public AugmentedBoardState(V15BoardState boardState)
    {
      this.boardState = boardState;

      whiteBitBoard = boardState.bitBoards[V15BoardState.WhitePawn]
        | boardState.bitBoards[V15BoardState.WhiteRook]
        | boardState.bitBoards[V15BoardState.WhiteKnight]
        | boardState.bitBoards[V15BoardState.WhiteBishop]
        | boardState.bitBoards[V15BoardState.WhiteQueen]
        | boardState.bitBoards[V15BoardState.WhiteKing];

      blackBitBoard = boardState.bitBoards[V15BoardState.BlackPawn]
        | boardState.bitBoards[V15BoardState.BlackRook]
        | boardState.bitBoards[V15BoardState.BlackKnight]
        | boardState.bitBoards[V15BoardState.BlackBishop]
        | boardState.bitBoards[V15BoardState.BlackQueen]
        | boardState.bitBoards[V15BoardState.BlackKing];
  ...
  private class CheckInfoBoardState
  {
    ...
    public CheckInfoBoardState(AugmentedBoardState boardState)
    {
      ...
      this.preservingKingPosition = boardState.boardState.bitBoards[boardState.boardState.whiteTurn ? V15BoardState.WhiteKing : V15BoardState.BlackKing].lsbUnchecked();
    }
  }
