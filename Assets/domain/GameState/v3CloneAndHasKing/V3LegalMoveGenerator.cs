...
public static class V3LegalMoveGenerator
{
  /// <summary>
  /// Doesn't take end game draws in consideration (three-fold nor 50 moves)
  /// </summary>
  public static List<Move> GenerateLegalMoves(this V3GameState gameState)
  {
  ...
  public static bool CanOwnKingDie(V3GameState gameState)
  {
    return CanKingDie(gameState.boardState, gameState.BoardState.WhiteTurn);
  }

  private static bool CanKingDieAfterMove(V3BoardState boardState, Move ownMove, bool whiteKing)
  {
    var kingMightBeInCheckState = boardState.PlayMove(ownMove).boardState;
    return CanKingDie(kingMightBeInCheckState, whiteKing);
  }

  private static bool CanKingDie(V3BoardState boardState, bool whiteKing)
  {
  ...
  private static List<Move> GeneratePseudoLegalMoves(V3BoardState boardState, bool white, bool canKillKingOnly = false)
  {
  ...
  private static List<Move> GetPseudoLegalMoves(V3BoardState boardState, PiecePosition piecePosition, bool canKillKingOnly)
  {
  ...
  private static List<Move> GetPseudoLegalPawnMoves(V3BoardState boardState, PiecePosition piecePosition, bool canKillKingOnly)
  {
  ...
  private static List<Move> GetPseudoLegalRookMoves(V3BoardState boardState, PiecePosition piecePosition, bool canKillKingOnly)
  {
  ...
  private static List<Move> GetPseudoLegalKnightMoves(V3BoardState boardState, PiecePosition piecePosition, bool canKillKingOnly)
  {
    var jumps = new[]{
  ...
  private static List<Move> GetPseudoLegalBishopMoves(V3BoardState boardState, PiecePosition piecePosition, bool canKillKingOnly)
  {
  ...
  private static List<Move> GetPseudoLegalQueenMoves(V3BoardState boardState, PiecePosition piecePosition, bool canKillKingOnly)
  {
    return GetPseudoRayMoves(boardState, piecePosition.position, 1, 0, piecePosition.pieceType.IsWhite(), canKillKingOnly)
      .Concat(GetPseudoRayMoves(boardState, piecePosition.position, -1, 0, piecePosition.pieceType.IsWhite(), canKillKingOnly))
      .Concat(GetPseudoRayMoves(boardState, piecePosition.position, 0, 1, piecePosition.pieceType.IsWhite(), canKillKingOnly))
  ...
  private static List<Move> GetPseudoLegalKingMoves(V3BoardState boardState, PiecePosition piecePosition, bool canKillKingOnly)
  {
    var landings = new[]{
  ...
  private static List<Move> GetPseudoRayMoves(V3BoardState boardState, BoardPosition position, int colIncrement, int rowIncrement, bool isWhite, bool canKillKingOnly)
  {
    var moves = new List<Move>();
